...
###############################################   	
	...
	if(rerun2){
		...
		brms_personality_dhglm_aggression <- readRDS("./brms_models/brms_personality_dhglm_aggression")
	}
...
###################################################
	...
	if(rerun3){
		...
		brms_personality_plasticity_shglm_aggression <- readRDS(here("brms_models", "brms_personality_plasticity_shglm_aggression"))
	}
...
```{r pers_plas, include=TRUE, message=FALSE, warning=FALSE, class.source='klippy'}
      ...
      # Extract blups
       blups_IDmo <- brms::posterior_samples(brms_personality_plasticity_shglm_aggression, pars = "r_id[[1-9].*,Intercept]")
...
##################################################################
	...
	if(rerun4){
		...
		brms_personality_plasticity_dhglm_aggression <- readRDS(here("brms_models", "brms_personality_plasticity_dhglm_aggression"))
	}
